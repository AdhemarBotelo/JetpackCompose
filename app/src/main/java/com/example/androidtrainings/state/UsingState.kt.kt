package com.example.androidtrainings.state
...
class UsingState : ComponentActivity () {
...
// we can define our own preview group and call it
@Preview(name = "small font", group = "fontScale", fontScale = 0.5f)
@Preview(name = "large font", group = "fontScale", fontScale = 1.5f)
